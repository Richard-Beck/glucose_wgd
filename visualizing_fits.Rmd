...
x <- masterrun(log(pars),dat = fit_dat,parNames = names(pars),gs = gs,ploidy="2N")
f <- masterfit(log(pars),dat = fit_dat,parNames = names(pars),gs = gs,ploidy="2N",verbose=T)
...
x <- masterrun(log(pars),dat = fit_dat,parNames = names(pars),gs = gs,ploidy="4N")
f <- masterfit(log(pars),dat = fit_dat,parNames = names(pars),gs = gs,ploidy="4N",verbose=T)
