...
gen_pars <- function(yxn,Ntrial){
  ...
  parmax <- c(kg=1/100,ng=20,g50c=1,kd=100,g50d=0.5,nd=20,ka=1,g50a=1,na=20)
  parmin <- c(kg=1/10000,ng=1,g50c=0.001,kd=0.1,g50d=0.001,nd=1,ka=0.4,g50a=0.001,na=1)
  parmax <- log(parmax)
  parmin <- log(parmin)
...
for(ploidy in c("2N","4N")){
  ...
  saveRDS(res,paste0("data/fitted_parameters/multistart_",ploidy,".Rds"))
}
