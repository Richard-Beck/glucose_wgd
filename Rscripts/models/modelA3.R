...
model_info <- function(){
  parnames <- c("kp", "theta", "na", "g50a", "kd", "nd", "g50d", "v"  , "m", "g50c", "g50y", "ky" , "delta_G" ,"N" , "D")
  lower <-    c(0.01, 6000   , 0.1 , 0.001 , 0.01, 0.1 , 0.001 , 1e-8 , 0.1, 0.001 , 5000  , 0.001, 0.0001    ,100 , 1)
  upper <-    c(1   , 50000  , 25  , 5     , 1   , 25  , 5     , 0.001, 25 , 5     , 500000, 1    , 0.5       ,1000, 500)
