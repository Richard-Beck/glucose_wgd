...
load_fit <- function(ploidy){
  par <- readRDS(paste0("opt_out/modelA3/",ploidy,".Rds"))$res
...
chain <- readRDS("best_pars/modelA3/4N_chain.Rds")
...
unpack_chain <- function(ploidy){
  chain <- readRDS(paste0("best_pars/modelA3/",ploidy,"_chain.Rds"))[[1]]
...
par <- c(kp=0.5,kd=1,v=1e-6,g50a=1,g50d=0.1,g50c=0.5,na=1,nd=10,m=3)
...
x2 <- viz_fits(50,"2N",model="modelA")
x4 <- viz_fits(50,"4N",model="modelA")
...
x2 <- viz_fits(100,"2N",gluconc = c(0.1,0.2,0.5,1),model="modelA")
x4 <- viz_fits(100,"4N",gluconc = c(0,0.1,0.2,0.5,1),model="modelA")
...
```{r}
df <- rbind(viz_mixexp(0.5,N = 50,times=1:120,model="modelA"),
            viz_mixexp(1,N = 50,times=1:120,model="modelA"),
            viz_mixexp(5,N = 50,times=1:120,model="modelA"))
...
```{r}
df <- rbind(delta_mixexp(0.5,N = 50,times=1:120,model="modelA"),
            delta_mixexp(1,N = 50,times=1:120,model="modelA"),
            delta_mixexp(5,N = 50,times=1:120,model="modelA"))
